...
<body>
    ...
    if ($com->connect_error ) {
        ...
        if($status){
            $sql="INSERT INTO amblogin(ambno, password, name) values ('$un','$ps','$na')";
            if ($com->query($sql)) {
    ...
    <form class="form-signin" method="post">       
      <h2 style="text-align:center;" class="form-signin-heading">Create Ambulance Account</h2><br>
      <input type="text" class="form-control" name="uname" placeholder="Ambulance Number" required="" autofocus /><br>
